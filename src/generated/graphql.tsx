...
export type LaunchProfileInfoQueryVariables = Exact<{
  id: Scalars['String'];
}>;


export type LaunchProfileInfoQuery = (
  { __typename?: 'Query' }
  & { launch?: Maybe<(
    { __typename?: 'Launch' }
...
export const LaunchProfileInfoDocument = gql`
...
/**
 * __useLaunchProfileInfoQuery__
 *
 * To run a query within a React component, call `useLaunchProfileInfoQuery` and pass it any options that fit your needs.
 * When your component renders, `useLaunchProfileInfoQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 ...
 * });
 */
export function useLaunchProfileInfoQuery(baseOptions?: Apollo.QueryHookOptions<LaunchProfileInfoQuery, LaunchProfileInfoQueryVariables>) {
        return Apollo.useQuery<LaunchProfileInfoQuery, LaunchProfileInfoQueryVariables>(LaunchProfileInfoDocument, baseOptions);
      }
export function useLaunchProfileInfoLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<LaunchProfileInfoQuery, LaunchProfileInfoQueryVariables>) {
          return Apollo.useLazyQuery<LaunchProfileInfoQuery, LaunchProfileInfoQueryVariables>(LaunchProfileInfoDocument, baseOptions);
        }
export type LaunchProfileInfoQueryHookResult = ReturnType<typeof useLaunchProfileInfoQuery>;
export type LaunchProfileInfoLazyQueryHookResult = ReturnType<typeof useLaunchProfileInfoLazyQuery>;
export type LaunchProfileInfoQueryResult = Apollo.QueryResult<LaunchProfileInfoQuery, LaunchProfileInfoQueryVariables>;